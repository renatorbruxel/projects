...
def build():
    ...
    payload = {
        ...
        'status_note':'Observed CRM mode uses these preserved educational records. Synthetic planning is an independent generated scenario with its own dates, metrics and manifest.',
